...
class ExplorationPolicy:
	...
	def _initialize_maneuver_params(self, maneuver):
		...
		if maneuver == ManeuverType.HIGH_SPEED_TURN:
			...
			params["throttle"] = np.random.uniform(0.6, 1.0)
			...
			params["throttle"] = np.random.uniform(0.5, 0.8)
			...
			params["throttle"] = np.random.uniform(0.8, 1.0)
			...
			params["drift_throttle"] = np.random.uniform(0.4, 0.7)
